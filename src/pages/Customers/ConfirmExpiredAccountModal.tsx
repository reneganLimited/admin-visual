...
const ConfirmExpiredAccountModal = ({
  isModalOpen,
  setIsConfirmOpen,
}: IProps) => {
    ...
    try {
      ...
      if (customer) {
        const customerPayload: CustomerToUpdate = {
          ...
          ModificationReason: "Usd Account Expired",
    ...
    <Modal isOpen={isModalOpen} closeModal={closeModal}>
      <div>
        <p className="text-center">
          ...
          to USD_ACCOUNT_EXPIRED
        </p>
        <p className="text-center">Are you sure?</p>
        <div className=" flex  justify-center">
          <Button
            text="Yes"
            handleClick={() => onConfirm(AccountState.USD_ACCOUNT_EXPIRED)}
...
export default ConfirmExpiredAccountModal;
